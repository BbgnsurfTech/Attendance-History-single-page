  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          ...
          body: Padding(
            padding:
                EdgeInsets.fromLTRB(0, 0, 0, AppSizeConfig.getAppHeight(0)),
            child: SideBar(HomeContent(), Icons.menu, false, Colors.transparent,
                Colors.white),
          ),
        ));
  }
          ...
          children: [
              ...
              children: [
                Container(
                    ...
                    padding: EdgeInsets.fromLTRB(
                        0,
                        AppSizeConfig.getAppHeight(3),
                        0,
                        AppSizeConfig.getAppHeight(7)),
                    margin: EdgeInsets.fromLTRB(
                        0, 0, 0, AppSizeConfig.getAppHeight(3)),
                    child: Container()),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ScreenTitleText.withColor(
                          text: "Attendance", color: Colors.white)
                    ],
                  ),
                ),
                Positioned(
            ...
            Container(
                ...
                margin: EdgeInsets.symmetric(
                    vertical: AppSizeConfig.getAppHeight(5),
                    horizontal: AppSizeConfig.getAppWidth(5)),
                decoration: BoxDecoration(
                  color: Colors.white,
                ...
                child: Column(children: [
                  Row(
                    children: [
                      Expanded(flex: 1, child: DayOfTheWeek()),
                    ],
                  ),
                  SizedBox(
                    height: AppSizeConfig.getAppHeight(3),
                  ),
                  Row(
                    children: [
                      Expanded(flex: 1, child: DayList()),
                    ],
                  ),
                ])),
            SizedBox(
...
class DayOfTheWeek extends StatelessWidget {
  List<String> days = ["Sun", "Mon", "Teu", "Wed", "Thur", "Fri", "Sat"];
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        children: days
            .map((e) => Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: AppSizeConfig.getAppWidth(2),
                      vertical: AppSizeConfig.getAppWidth(5)),
                  child: Center(
                      child: Text(
                    e,
                    style: TextStyle(
      ...
      child: Ink(
        ...
        child: ListTile(
          ...
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(AppSizeConfig.getGeneralImage(12)),
          ),
          title: Text(
            text,
            style: TextStyle(
  ...
  return Column(
    ...
    children: [
      Text(
        number,
        style: TextStyle(
            color: numberColor, fontSize: font26, fontWeight: FontWeight.bold),
      ),
      Text(
        '.',
        style: TextStyle(
            color: dotColor, fontSize: font26, fontWeight: FontWeight.bold),
      )
    ],
  );
}
      ...
      child: Row(
        ...
        children: dateNumbers
            .map((e) => Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: AppSizeConfig.getAppWidth(2),
                    vertical: AppSizeConfig.getAppWidth(2)),
...
Widget DayList() {
  ...
  return Column(
    children: list.map((e) => DateNumber(dateNumbers: e)).toList(),
  );
}
